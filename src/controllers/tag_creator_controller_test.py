...
def test_create(mock_create_barcode):
    mock_valaue = "image_path"
    mock_create_barcode.return_value = mock_valaue
    tag_creator_controller = TagCreatorController()

    result = tag_creator_controller.create(mock_valaue)
    ...
    assert result["data"]["path"]== f'{mock_valaue}.png'
